export const getMailMessageForIdeaCreator = ({ comment, commenter, isAnomyous, idea }) => {
    return `
    <!DOCTYPE html>
        <html>
        <head>
        ...
        <body>
            <h1>New Comment Arrive</h1>
            <p>${isAnomyous ? "Someone" : commenter} has commented on your idea</p>
...
export const getMailMessageForCordinator = ({ topic, content }) => {
    return `
    <!DOCTYPE html>
        <html>
        <head>
